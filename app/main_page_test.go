...
// The Book struct is already defined in main_page.go, but we're in the same package
// so we don't need to redefine it here. This comment is just for documentation.
